...
function initLandmarkTours() {
  ...
  const tourKind = document.querySelector("#tour-kind");
  const tourCredit = document.querySelector("#tour-credit");
  const tourSource = document.querySelector("#tour-source");
  const landmarks = {
    eiffel: {
      name: "Eiffel Tower",
      location: "Paris, France",
      kind: "Historic aerial photograph",
      image: "assets/landmarks/eiffel.jpg",
      alt: "Historic aerial photograph of the Eiffel Tower grounds",
      credit: "Image: Alphonse Liebert, public domain.",
      source: "https://commons.wikimedia.org/wiki/File:Aerial_view_of_Eiffel_Tower_and_Exposition_Universelle,_Paris,_1889.jpg"
    },
    pyramids: {
      name: "Giza Pyramids",
      location: "Giza, Egypt",
      kind: "Aerial photograph",
      image: "assets/landmarks/pyramids.jpg",
      alt: "Aerial view of the Great Pyramids of Giza",
      credit: "Image: puzzles-games.eu, Wikimedia Commons attribution license.",
      source: "https://commons.wikimedia.org/wiki/File:Great-Pyramids-of-Giza-Aerial-View-Cairo-Egypt.jpg"
    },
    colosseum: {
      name: "Colosseum",
      location: "Rome, Italy",
      kind: "Aerial photograph",
      image: "assets/landmarks/colosseum.jpg",
      alt: "Aerial view of the Colosseum in Rome",
      credit: "Image: Giuseppe Milo, CC BY 3.0.",
      source: "https://commons.wikimedia.org/wiki/File:Aerial_View_Of_The_Colosseum_Rome_Italy_Aerial_Photography_(151212315).jpeg"
    },
    taj: {
      name: "Taj Mahal",
      location: "Agra, India",
      kind: "Aerial photograph",
      image: "assets/landmarks/taj.png",
      alt: "Aerial view of the Taj Mahal from a helicopter",
      credit: "Image: Architguptaaviatorflight, CC BY-SA 4.0.",
      source: "https://commons.wikimedia.org/wiki/File:Aerial_View_of_Taj_Mahal_by_Helicopter.png"
    }
  };
  ...
  function setTour(tourId) {
    ...
    image.alt = landmark.alt;
    tourName.textContent = landmark.name;
    tourLocation.textContent = landmark.location;
    tourKind.textContent = landmark.kind;
    tourCredit.textContent = landmark.credit;
    tourSource.href = landmark.source;
    ...
    if (stage) {
      ...
      window.requestAnimationFrame(() => stage.classList.add("is-flying"));
    }
  }
